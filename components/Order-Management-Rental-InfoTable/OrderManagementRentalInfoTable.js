...
function OrderManagementRentalInfoTable() {
  return (
    <>
      <div className="b-member-Rental-order-orderlist-detail-all">
        <div className="b-member-Rental-order-div-title">
          <p>租賃訂單詳情</p>
        </div>
        <div className="row b-member-Rental-order-orderlist-detail">
          <table className="table table-borderless">
            <tbody>
              <tr>
                <td className="b-member-Rental-order-style1">訂單編號：</td>
                <td className="b-member-Rental-order-style2">012021020201</td>
              ...
              <tr>
                ...
                <td className="b-member-Rental-order-style2">2020-12-12</td>
                <td className="b-member-Rental-order-style1">收件人：</td>
                <td className="b-member-Rental-order-style2">傅芷萱</td>
              </tr>
              <tr>
                ...
                <td className="b-member-Rental-order-style2">
                  320桃園市中壢區中大路300號國立中央大學
                </td>
              </tr>
              <tr>
                <td className="b-member-Rental-order-style1">出貨日期：</td>
                <td className="b-member-Rental-order-style2">2020-12-13</td>
              </tr>
              <tr>
            ...
            <tbody style={{ background: '#EBEBEB' }}>
              <tr>
                ...
                <td className="b-member-Rental-order-style2">NT$140,000</td>
              ...
              <tr>
                ...
                <td className="b-member-Rental-order-style2">NT$0</td>
                <td className="b-member-Rental-order-style1">訂單狀態：</td>
                <td className="b-member-Rental-order-style2">2已完成</td>
              </tr>
              <tr>
