...
function CheckoutTableItemListPurchase() {
  return (
    <>
            ...
            <table className="table table-borderless">
              <thead className="text-muted ">
                <tr className="large text-uppercase d-flex justify-content-between b-complete-tableTitle-buy">
                  ...
                  <th scope="col" width="17%" className="text-center p-2">
                    產品名稱
                  </th>
                  <th scope="col" width="11%" className="text-center p-2">
                    價格
                  </th>
                  <th scope="col" width="20%" className="text-center p-2">
                    租賃分類
                  </th>
                  <th scope="col" width="12%" className="text-center p-2">
                    數量
                  </th>
                  <th scope="col" width="12%" className="text-center p-2">
                    小記
                ...
                <tr className="d-flex justify-content-between">
                  ...
                  >
                    <class className="aside">
                      <img
                        src="http://localhost:3000/images/檸檬香蜂草禮盒.jpg"
                        className="b-complete-img-sm-buy"
                      />
                    </class>
                  </th>
                  <td
                  ...
                  <td
                    height="140"
                    width="12%"
                    className="b-completepage-detailinfo-buy justify-content-center"
                  >
                    <p>5</p>
                  </td>
                  <td
      ...
      <div className="b-completepage-button-to-mainpages-buy">
        <NavLink to="" className="" data-abc="true">
          {' '}
          返回購物{' '}
        </NavLink>
      </div>
