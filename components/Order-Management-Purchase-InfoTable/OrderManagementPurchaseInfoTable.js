...
function OrderManagementPurchaseInfoTable() {
  return (
    <>
      <div className="b-member-purchase-order-orderlist-detail-all">
        <div className="b-member-purchase-order-div-title">
          <p>選購訂單詳情</p>
        </div>
        <div className="row b-member-purchase-order-orderlist-detail">
          <table className="table table-borderless">
            <tbody>
              ...
              <tr>
                ...
                <td className="b-member-purchase-order-style2">
