  ...
  return (
    ...
    <div className="v-max">
        <nav  aria-label="breadcrumb">
            ...
            <li className="breadcrumb-item active v-li"><NavLink className="v-li" style={{color: "#494949"}} to="/">首頁</NavLink></li>
                <li className="breadcrumb-item active v-li"><NavLink className="v-li" style={{color: "#494949"}} to="/rentalguide">植物租賃</NavLink></li>
                <li className="breadcrumb-item active v-li"><NavLink className="v-li" style={{color: "#6C8650"}}  to="/rental/list">租賃商品</NavLink></li>
            </ol>
        </nav>
      </div>
    </>
